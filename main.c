...
void login_user() {
    ...
    if (cred_check == 1) {  // Successful login
    ...
    else if (cred_check == -1) {  // Incorrect password
    ...
    else if (cred_check == 0) {  // User ID does not exist
            ...
            case 1:
                for (int i = 0; i < tickets_count; i++) {
                    ...
                    if (tickets[i].priority == 2) {
                        ...
                        printf("Status: ");
                        switch (tickets[i].status) {
                            case 0: printf("en cours\n"); break;
                            case 1: printf("resolved\n"); break;
                            case 2: printf("fermee\n"); break;
                        }
                        printf("Date: %s\n", date);
                        printf("Owner ID: %d\n", tickets[i].owner_id);
                        printf("Priority: ");
...
void login_admin() {
    ...
    if (tentative_admin >= 3 && difftime(time(NULL), attemp_admin) < 86400) { // 86400 seconds = 24 hours
